...
#include "../mink/coordinate_map_cpu.hpp"
#include "../mink/types.hpp"
#ifndef CPU_ONLY
#include "../mink/coordinate_map_gpu.cuh"
#endif
#include <stdexcept>
...
// Define destructor here so it's only instantiated with full type information
...
std::vector<at::Tensor> CoordinateManager::union_map(
  ...
  return std::visit([&](auto& manager_ptr) {
    ...
    // Call union map - returns pair<key, maps>
