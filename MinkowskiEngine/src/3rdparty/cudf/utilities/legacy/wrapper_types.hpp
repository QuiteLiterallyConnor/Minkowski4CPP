...
// Note: MSVC's traditional preprocessor causes namespace ambiguity with PyTorch headers
// when compiling CUDA code. We skip these std::numeric_limits specializations in that case.
